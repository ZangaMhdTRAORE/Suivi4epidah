...
HTML(
  "<marquee behavior='scroll' 
           ...
           onmousedown='this.stop();'
           onmouseup='this.start();'>
     <img src='www/vaccin1.jpg'> 
     <img src='www/Affiche.jpg'> 
     <img src='www/covid.jpg'>
     </marquee>"
)
```
...
HTML("<div class='body'>
<h2><b>DÉPISTAGE</b></h2>
<p>Rendez-vous sur le  <a href='https://bf.usembassy.gov/u-s-citizen-services/covid-19-information/'> site
</a> de l'embassade des Etats Unies au Burkina Faso pour les informations sur le dépistage de la Covid au Burkina Faso</p>
</div>")
```
...
<div class='point'> <i class='fa-solid fa-earth-africa'></i><b>  Site web : </b>
